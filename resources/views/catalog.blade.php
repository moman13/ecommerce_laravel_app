...
<head>
    ...
    <link rel="stylesheet" href="assets/css/simple-rating.css">  
</head>
<body>
<!--[if lt IE 10]>
...
<header class="xs-header header-transparent">
    ...
    <div id="catalog_page" class="ptb ptb-xs-60 page-signin">
            <div class="container">
              <div class="row">
                <div class="col-md-10">
                    <div class="main-body">
                        <div class="item">
                            <div class="thump">
                                <a href="#">
                                    <img src="assets/images/234x180/product_1_234x180.jpg" alt="">
                                </a>
                            </div>
                            <div class="details">
                                <h3 class="title">
            ...
            <ul class="pagination justify-content-center">
                    <li class="page-item disabled">
                        <a class="page-link" href="#" tabindex="-1"><i class="icon icon-double-left-chevron"></i></a>
                    </li>
                    ...
                    <li class="page-item">
                        <a class="page-link" href="#"><i class="icon icon-double-angle-pointing-to-right"></i></a>
                    </li>
                </ul>
          </div>
